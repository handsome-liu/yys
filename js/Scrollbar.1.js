...
class Scrollbar {
    ...
    scroll(speed) {
        this.$con.each(index => {
             ...
             */
            const scrollHeight = this.$scroll.eq(index).height(), prop = scrollHeight / this.$con.eq(index).height();
    ...
    dragBar() {
        ...
        this.$bar.each(index => {
            ...
            const scrollHeight = this.$scroll.eq(index).height(), prop = scrollHeight / this.$con.eq(index).height(), barHeight = prop * scrollHeight;
            this.$bar
                .eq(index)
                .height(barHeight)
